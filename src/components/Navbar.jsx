...
const Navbar = () => {
    ...
    //handelin the size of the screen by autoadjusting the page according the scrren ratio;
    useEffect(() => {
...
// this use effect will track the screen size and close the side Bar if we on a small device;
    useEffect( ()  => {
        if(screenSize <= 900){
           setActiveMenu(false);
        }else{
